...
var calcCTC =  function(InputOTE,inputcountry,InputBand ,InputselectedPlan)
		...
		if(selectedPayplan =='ABP' && ( (selectedSubBand == 'B3_1') || (selectedSubBand == 'B3_2') ) ){
			 ...
			 fp = parseFloat(InputOTEvalue/1.20);
			 ...
			 fp = parseFloat(InputOTEvalue/1.67);
			 ...
			 fp = parseFloat((InputOTEvalue)/1.05);
			 ...
			 fp = parseFloat((InputOTEvalue)/1.10);
			 variablePayPerctange = 10;
			 ...
			 fp = parseFloat((InputOTEvalue)/1.15);
			 ...
			 fp = parseFloat((InputOTEvalue)/1.25);
			 ...
			 fp = parseFloat((InputOTEvalue)/1.30);
			 ...
			 fp = parseFloat((InputOTEvalue)/1.40);
			 ...
			 fp = parseFloat((InputOTEvalue)/1.50);
		...
		if(selectedPayplan =='ABP' && selectedSubBand =='B8_1'){
			...
			ctcCalculation['annualBasic'] = (selectedCountry=='SaudiArabia' || selectedCountry=='UAE') ? (40 * fp)/100 : (selectedCountry=='SriLanka') ? (30 * InputOTEvalue)/100 :  ( selectedCountry=='INDIA' && selectedSubBand == 'B1_1') ? (40 * InputOTEvalue)/100 : ( selectedCountry=='INDIA' && selectedSubBand != 'B1_1') ?(28 * InputOTEvalue)/100 : 0;
