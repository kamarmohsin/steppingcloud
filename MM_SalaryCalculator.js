...
var $mj = jQuery.noConflict();
	...
	$mj(document).ready(function(){
		...
		var arrayOfElem = ['calculateForGrade', 'BasicSal_mon', 'BasicSal_an', 'adhocPay_mon', 'adhocPay_an', 'pfBase_mon', 'pfBase_an', 'pf_mon', 'pf_ann', 'gratuity_mon', 'gratuity_ann', 'superannuation_mon', 'superannuation_ann', 'retirals_mon', 'retirals_ann', 'totalFixed_mon', 'totalFixed_ann', 'flexiPay_mon', 'flexiPay_an', 'bonusExgratia_mon', 'bonusExgratia_an', 'totalGuaranteed_mon', 'totalGuaranteed_an', 'performancePay_mon', 'performancePay_an', 'ctc_mon', 'ctc_an', 'grossPay_mon', 'grossPay_an'  ];
			...
			var calcCTC =  function(offerCtc, inputlevel, inputcompany){
				...
				CTCcalculation = {
						...
						'gratuity_mon':0,
						'gratuity_ann':0,
						'superannuation_mon':0,
						'superannuation_ann':0,
						'retirals_mon':0,
						'retirals_ann':0,
						'totalFixed_mon':0,
						'totalFixed_ann':0,
						...
						'bonusExgratia_mon':0,
						'bonusExgratia_an':0,
						'totalGuaranteed_mon':0,
						'totalGuaranteed_an':0,
				...
				if (company == '1037') {
					...
					CTCcalculation['gratuity_ann'] = Math.round(0.0481 * CTCcalculation['pfBase_an']);
					...
					CTCcalculation['retirals_ann'] = Math.round( (16.81 * CTCcalculation['pfBase_an'])/100 );
			...
			else if (company == '1001' || company == '1019' || company == '1020' || company == '1021') {
					...
					*/
					...
					CTCcalculation['superannuation_ann'] = Math.round(superann[level] *	CTCcalculation['pfBase_an']);
					CTCcalculation['superannuation_mon'] =	CTCcalculation['superannuation_ann'] / 12;

					CTCcalculation['retirals_ann'] = CTCcalculation['pf_ann'] + CTCcalculation['gratuity_ann'] + CTCcalculation['superannuation_ann'];
					CTCcalculation['retirals_mon'] = CTCcalculation['retirals_ann'] /12;
			...
			else if (company == '1049' || company == '1054' || company == '1055') {
					...
					*/
					...
					var esic = {
						...
						'jr_Officer': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'Officer': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'sr_Officer': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'executive': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'sr_executive': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'manager': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'sr_Manager': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'dgm': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'gm': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'asst_VP': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'VP': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'sr_VP': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
					...
					CTCcalculation['retirals_ann'] = CTCcalculation['pf_ann'] + CTCcalculation['gratuity_ann'];
					CTCcalculation['retirals_mon'] = CTCcalculation['retirals_ann'] /12;
					...
					CTCcalculation['performancePay_mon'] = CTCcalculation['performancePay_an'] /12;
					CTCcalculation['flexiPay_an'] = inputCTC_an - CTCcalculation['pfBase_an'] - (retirals[level] * CTCcalculation['pfBase_an']) - CTCcalculation['performancePay_an'] - CTCcalculation['bonusExgratia_an'] - esic[level] ;
					CTCcalculation['flexiPay_mon'] = CTCcalculation['flexiPay_an'] /12;
					...
					CTCcalculation['totalAllow_ann'] = CTCcalculation['hra_ann'] + CTCcalculation['conveyance_ann'] + CTCcalculation['medical_ann'] + CTCcalculation['education_ann'] + CTCcalculation['lta_ann'] + CTCcalculation['field_ann'];
					...
					CTCcalculation['ctc_an'] = CTCcalculation['pfBase_an'] + CTCcalculation['retirals_ann'] + CTCcalculation['totalAllow_ann'] + CTCcalculation['bonusExgratia_an'] ;
					CTCcalculation['ctc_mon']  = CTCcalculation['ctc_an'] /12;
	...
	{ 
        ...
        for( var key in sal){
        	...
        	if(key == 'calculateForGrade' || key == 'graduityPercent' || key == 'gridmatrix')
